...
1. From the Import screen, enter Sonar as the name for the user flow.
1. Copy the code from **Amazon-Verified-Permissions-Recipe.json** and paste it into the Configuration text box.
1. Click **Create**.
